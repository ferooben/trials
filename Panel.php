...
<!-- Mirrored from chuibility.github.io/inspinia/mail_compose.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Jan 2021 18:54:13 GMT -->
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="block m-t-xs font-bold">Hoşgeldiniz <?php echo $_SESSION["username"]; ?> </span> 
                        </a> 
                    </div>
            ...
            <div class="mail-box-header"> 
                ...
                <div class="mail-body">
                    ...
                    <form method="Post" action="Gonder.php"> 
                    	<div class="form-group row"><label class="col-sm-2 col-form-label">Ad ve Soyad:</label> 
                            <div class="col-sm-10"><input type="text" class="form-control" value="" name="adSoyad" placeholder="Adınızı ve soyadınızı giriniz..."></div>
                        </div>
                        <div class="form-group row"><label class="col-sm-2 col-form-label">Kime:</label> 
                            <div class="col-sm-10"><input type="text" class="form-control" value="" name="To" placeholder="Gönderilecek eposta adresini giriniz..."></div>
                        </div>
                        <div class="form-group row"><label class="col-sm-2 col-form-label">Konu:</label> 
                            <div class="col-sm-10"><input type="text" class="form-control" value="" name="Subject" placeholder="Konunuz nedir?"></div> 
                        </div>
                        <div class="mail-text h-100">  
                        	<textarea class="summernote" name="Mesaj" >Mesajınızı giriniz...</textarea>  
                        </div>
                        <div class="mail-body text-right tooltip-demo">
                        	<button class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Send"><i class="fa fa-reply"></i> Gönder</button>   
                    </form>
...
<!-- Mirrored from chuibility.github.io/inspinia/mail_compose.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Jan 2021 18:54:14 GMT -->
</html>
